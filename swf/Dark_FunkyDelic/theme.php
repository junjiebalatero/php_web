<?php // $Id: theme.php,v 1.5.1 20/08/2001 16:41 kodred Exp $ $Name:  $
global $thename, $bgcolor5, $bgcolor6;
/************************************************************************/
/* Dark_FunkyDelic - LAYOUT FOR PostNUKE (http://postnuke.com)          */
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
    global $thename, $anonymous, $tipath, $bgcolor3, $bgcolor2, $bgcolor1, $bgcolor5;
    echo  "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"1\" bgcolor=\"$bgcolor5\">\n"
    ."<tbody>\n"
    ."<tr>\n"
...
global $bgcolor5, $bgcolor4, $thename, $bgcolor1;
echo "<table bgcolor=\"$bgcolor5\" border=\"0\" width=\"160\" cellspacing=\"0\" cellpadding=\"0\">\n"
    ...
    ."</tr>\n"
    ."<tr>\n"
    ."<td bgcolor=\"$bgcolor4\" class=\"pn-normal\">$block[content]</td></tr>\n"
    ."</tbody>\n"
    ."</table>\n"
    ."<TABLE WIDTH=\"100%\" BORDER=\"0\" CELLPADDING=\"0\" CELLSPACING=\"0\">\n"
    ."<tbody>\n"
    ...
    ."<TD width=\"1\"><img src=\"themes/$thename/images/pix.gif\" width=\"1\" height=\"1\" border=0 Alt=\"\"></TD>\n"
    ."</TR>\n"
    ."</tbody>\n"
    ."</TABLE>\n"
    ."</td>\n"
