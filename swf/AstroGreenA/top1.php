...
print "<TABLE border=0 cellPadding=0 cellSpacing=0 width=\"100%\" bgcolor=\"$bgcolor2\">
                <TBODY> 
                <TR> <TD width=\"3%\">
                  <IMG alt=Search border=0 height=34 src=\"themes/AstroGreenA/images/menu1.gif\" 
  ...
  <area shape=\"rect\" coords=\"371,8,425,21\" href=\"search.php\" alt=\""._SEARCH."\" title=\""._SEARCH."\">
              ...
              </TABLE><IMG SRC=\"themes/AstroGreenA/images/black.gif\" WIDTH=\"100%\" HEIGHT=\"1\" BORDER=0>";
...
useronline();
     ...
     echo "<center>"._REGUSERS." <font color=\"#005500\"><b>$numrows</b></font>\n";
...
while(list($type, $var, $count) = mysql_fetch_row($result)) {
	if(($type == "total") && ($var == "hits")) {
		$total = $count;
    echo  ""._WERECEIVED." <font color=\"#005500\"><b>$total</b></font> "._PAGESVIEWS." Jun 2001.";
	}
}
...
mysql_close;
print ("  "._CURRENTLY."  <font color=\"#005500\"><b>$count</b></font> "._GUESTS." "._MEMBERS."</center>\n");
}
