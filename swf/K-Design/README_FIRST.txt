...
===================
     ...
     -Troubleshooting with the backgrounds images(CSS loading): 
      ...
      You need to edit style.css (http://www.your-site.com/themes/K-Design/style/style.css)
      Change all the lines like this one:
     
       background-image : url(/themes/K-Design/images/image.gif)
     
     By:
       
       background-image : url(http://your-full-url/themes/K-Design/images/image.gif)
       "Just add your FULL URL before /themes/K-Design/*.gif"
