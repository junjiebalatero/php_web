...
<a href=$nuke_url><img src=themes/SlashOcean/images/logo.gif Alt=\""._WELCOMETO." $sitename\" border=0></a>
	...
	if ("$aid" == "$informant") { ?>
		...
		<table border="0" cellpadding="0" cellspacing="0"><tr bgcolor="#e6e6e6">
			...
			<td width="100%">
				...
				<td><font size="1"><?php echo ""._POSTEDBY." "; ?> <?php formatAidHeader($aid) ?> <?php echo ""._ON.""; ?> <?php echo"$datetime $timezone"; ?> (<?php echo $counter; ?> <?php echo ""._READS.""; ?>)</font></td>
				</tr></table>
			</td>
...
<?php	} else {
		...
		$boxstuff .= "<font size=2>"._WRITES." <i>\"$thetext\"</i> $notes";
?>		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr valign="top" bgcolor="#101070">
			<td><img src="themes/SlashOcean/images/cl.gif" width="7" height="10" alt=""><img src="themes/SlashOcean/images/pix.gif" width="4" height="4" alt=""></td>
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
	...
	if ("$aid" == "$informant") { ?>
		...
		<table border="0" cellpadding="0" cellspacing="0"><tr bgcolor="#e6e6e6">
			...
			<td width="100%">
				<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>
				<td><font size="1"><?php echo ""._POSTEDBY." "; ?> <?php formatAidHeader($aid) ?> <?php echo ""._ON.""; ?> <?php echo"$datetime $timezone"; ?></font>

<?php
if ($admin) {
    echo "&nbsp;&nbsp; <font size=2> [ <a href=admin.php?op=EditStory&sid=$sid>"._EDIT."</a> | <a href=admin.php?op=RemoveStory&sid=$sid>"._DELETE."</a> ]";
}
?>
				</td>
				</tr></table>
...
<?php echo ""._CONTRIBUTEDBY.""; ?> <?php echo "<a href=\"user.php?op=userinfo&uname=$informant\">$informant</a>"; ?>
				</td>
				</tr></table>
			</td>
			<td background="themes/SlashOcean/images/gr.gif"><img src="themes/SlashOcean/images/pix.gif" width="11" height="11" alt=""></td>
