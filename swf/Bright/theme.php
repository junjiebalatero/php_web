...
$bgcolor5 = "#BBCCDD";  # left and right block background color
$bgcolor6 = "#FFFFFF";  # header and footer background color
$bgcolor7 = "#778899";  # Trim line that surrounds each block
$bgcolor8 = "#FFBB00";  # Left and right block title area background color
$bgcolor9 = "#BBCCDD";  # Center block title area background color
$bgcolor10 = "#BBCCDD";  # header and footer block underline background color

$textcolor1 = "#000000"; # center block default title text color
$textcolor2 = "#303030"; # left and right block default title text color
...
$textcolor6 = "#303030"; # header and footer default text color
