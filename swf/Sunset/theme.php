...
echo "<a href=$nuke_url><img src=themes/Sunset/logo.gif Alt=\""._WELCOMETO." $sitename\" border=0></a>\n";
echo "</td>\n";
if ($banners) {
echo "<td>";
    include("banners.php");
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
    ...
    echo "<img src=\"themes/Sunset/bullet.gif\" border=0 hspace=3><font size=3><b>$title</b></font><br>\n";
    ...
    echo "<font size=2>$morelink</font><br><img src=themes/Sunset/line.gif border=0 vspace=4>\n";
    echo "</td></tr></table>\n";
    echo "</td></tr></table>\n";
    echo "<br>\n\n\n";
}
...
function themearticle($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
    ...
    echo "<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"5\" bgcolor=FFFFFF><tr><td>\n";
    echo "<a href=search.php?topic=$topic><img src=$tipath$topicimage Alt=\"$topictext\" border=0 align=right></a>\n";
    echo "<img src=\"themes/Sunset/bullet.gif\" border=0 hspace=3><font size=2><b>$title</b></font>\n";
    if ($admin) {
...
function themesidebox($title, $content) {
    ...
    echo "<img src=\"themes/Sunset/left$rcolor.gif\" alt=\"\" border=\"0\" width=\"5\" height=\"19\"></td>\n";
    echo "<td bgcolor=$tcolor width=\"100%\"><b><font size=\"2\" color=\"#FFFFFF\">$title</font></b></td>\n";
    echo "<td align=\"right\"><img src=\"themes/Sunset/right$rcolor.gif\" alt=\"\" border=\"0\" width=\"5\" height=\"19\"></td></tr></table>\n";
    ...
    echo "<img width=\"100%\" height=\"5\" src=\"themes/Sunset/bottom$rcolor.gif\" vspace=\"0\" border=\"0\"></td></tr></table>\n";
    echo "<br>\n\n\n";
}
