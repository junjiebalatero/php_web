...
$bgcolor1 = "#778899";  # primary background color
$bgcolor2 = "#FFFFFF";  # Comments nav bar background color
$bgcolor3 = "#778899";  # block area background color
$bgcolor4 = "#FFFFFF";  # center block background color
$bgcolor5 = "#FFFFFF";  # left and right block background color
$bgcolor6 = "#333333";  # header and footer background color
$bgcolor7 = "#000000";  # Trim line that surrounds each block
$bgcolor8 = "#CCCCCC";  # Left and right block title area background color
$bgcolor9 = "#CCCCCC";  # Center block title area background color
$bgcolor10 = "#666666";  # header and footer block underline background color
...
$textcolor6 = "#EEEEEE"; # header and footer default text color
...
function themeheader() {
    ...
    echo "<table bgcolor=\"$bgcolor6\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" width=\"100%\">
          <tr>
                <td>
                        <a href=\"index.php\">
                        <img src=\"themes/$thename/images/logo.gif\" border=\"0\" alt=\""._WELCOMETO." $sitename\" align=\"left\"></a>
                </td>
                <TD align=right><form action=search.php method=post><font size=2 color=$textcolor6>
                        <input type=text name=query><input type=\"SUBMIT\" value=\""._SEARCH."\"></form>
                </td>
          </tr>
          </table>";
