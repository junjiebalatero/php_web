...
function onlineHead() {
    ...
    $who_online_num = $guest_online_num + $member_online_num;
        if ($member_online_num != 0){
                $memTag .= "Members online: ";
    }
    // These two if then statements check to see if the words Guest and Member should
    // Be singular or plural for correct grammar. Change to suit your language needs.
    ...
    // end check for plurality of nouns.

    $who_online = "$guest_online_num $guestsTag and $member_online_num $membersTag Online.<br>$memTag";
...
global $bgcolor1, $bgcolor2, $bgcolor3, $bgcolor4, $bgcolor5, $bgcolor6, $bgcolor7, $textcolor1, $textcolor2, $textcolor3, $textcolor4;
    ...
    echo "<body text=\"#000000\" link=\"#000000\" vlink=\"#000000\" alink=\"#000000\" topmargin=\"0\" leftmargin=\"0\" marginwidth=\"0\" marginheight=\"0\">\n"
          ...
          ."<td align=\"right\"><a href=\"/index.php\"><img src=\"/themes/Cyan2/images/logo.gif\" alt=\""._WELCOMETO." $sitename\" border=\"0\"></a></td></tr>\n"
          ."</table>\n"
    ...
    if ($username == "Anonymous") {
      ...
      echo ""._WELCOME." $username: <a href=\"/user.php\">"._OPTIONS."</a> | <a href=\"/user.php?op=logout\">"._LOGOUT."</a>";
    }
    echo  "</font></td>\n"
          ...
          ."<tr><td align=\"center\" valign=\"top\" width=\"155\">\n"
